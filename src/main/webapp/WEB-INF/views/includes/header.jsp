...
<head>
    ...
    <title>Admin Page - WebFlix</title>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="/admin/admin_movie"><i class="fa fa-sitemap fa-fw"></i>Movie List</a>
                        </li>
                        <li>
                            <a href="/admin/admin_tv"><i class="fa fa-sitemap fa-fw"></i>Tv List</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
