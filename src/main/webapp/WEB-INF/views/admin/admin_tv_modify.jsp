...
<div class="row">
  <div class="col-lg-12">
    <h1 class="page-header">Tv Modify</h1>
  </div>
  <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
...
<div class="row">
  <div class="col-lg-12">
    <div class="panel panel-default">
      ...
      <div class="panel-heading">Tv Modify Page</div>
      <!-- /.panel-heading -->
      <div class="panel-body">

      <form role="form" action="/admin/admin_tv_modify" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input class="form-control" name='poster'
            value='<c:out value="${tv_get.poster}"/>'>
        </div>

		<div class="form-group">
          <label>제목</label> <input class="form-control" name='title'
            value='<c:out value="${tv_get.title}"/>'>
        </div>
        
        <div class="form-group">
          <label>연도</label> <input class="form-control" name='year'
            value='<c:out value="${tv_get.year}"/>'>
        </div>
...
$(document).ready(function() {
	  ...
	  $('button').on("click", function(e){
	    ...
	    if(operation === 'remove'){
	      formObj.attr("action", "/admin/admin_tv_remove");
	      
	    }else if(operation === 'list'){
	      //move to list
	      formObj.attr("action", "/admin/admin_tv_get").attr("method","get");
