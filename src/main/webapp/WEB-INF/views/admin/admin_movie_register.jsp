...
<div class="row">
  <div class="col-lg-12">
    <div class="panel panel-default">
      ...
      <div class="panel-heading">Movie Register</div>
      <!-- /.panel-heading -->
      <div class="panel-body">

        <form role="form" action="/admin/admin_movie_register" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label>구분번호</label> <input class="form-control" name='div_num' value="1" readonly="readonly">
          </div>
